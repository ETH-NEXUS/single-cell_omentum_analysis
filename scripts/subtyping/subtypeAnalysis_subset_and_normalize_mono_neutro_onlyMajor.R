...
# Monocytes and neutrophil cells
...
neutro_sub1 <- combined[, combined$umap_cohort_cl %in% take_neutro]
mono_sub1 <- combined[, combined$umap_cohort_cl %in% take_mono]

# then take the desired cell type
neutro_sub <- neutro_sub1[, colData(neutro_sub1)$celltype_major == "Myeloid.cells"]
mono_sub <- mono_sub1[, colData(mono_sub1)$celltype_major == "Myeloid.cells"]
