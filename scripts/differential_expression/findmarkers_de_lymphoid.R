###################################################
## File name: findmarkers_de_lymphoid.R
## Author: Matteo Carrara
###################################################

## GENERAL:
## This script performs a full DE analysis of lymphoid cells using findMarkers
...
tmp=readRDS("lymphoid_.subtype_sce.RDS")
...
phm <- pheatmap(t(myexpression_gex), color = hmcol, scale = "column", fontsize = 12,
                             ...
                             fontsize_col=8)
              ggsave("DE_heatmap_gex_top10_noselection.pdf", phm$gtable,
...
phm <- pheatmap(t(myexpression_gex_n), color = hmcol, scale = "column", fontsize = 12,
                             ...
                             fontsize_col=8)
              ggsave("DE_heatmap_gex_top10_noselection_normcounts.pdf", phm$gtable,
                     width = 35, height = 20, units = "cm")
...
for(i in 1:length(myclusters)){
 ...
 gene[[i]] = gene_presence[which(gene_presence$frac_contrasts>0.75),]


 message(nrow(gene_presence[which(gene_presence$frac_contrasts>0.75),]))
...
phm <- pheatmap(t(myexpression_gex), color = hmcol, scale = "column", fontsize = 12,
                             ...
                             main = "Top differentially expressed GEX average raw expression",
                             fontsize_col = 4)
              ggsave("DE_heatmap_gex_075_select.pdf", phm$gtable,
...
phm <- pheatmap(t(myexpression_gex_n), color = hmcol, scale = "column", fontsize = 12,
                             ...
                             main = "Top differentially expressed GEX average normalized expression",
                             fontsize_col = 4)
              ggsave("DE_heatmap_gex_075_select_normcounts.pdf", phm$gtable,
                     width = 60, height = 20, units = "cm")
...
phm <- pheatmap(t(myexpression_gex), color = hmcol, scale = "row", fontsize = 12,
                             ...
                             main = "Top differentially expressed GEX average raw expression",
                             fontsize_col = 4)
              ggsave("DE_heatmap_gex_075_select_rowscale.pdf", phm$gtable,
                     width = 60, height = 20, units = "cm")
...
phm <- pheatmap(t(myexpression_gex_n), color = hmcol, scale = "row", fontsize = 12,
                             ...
                             main = "Top differentially expressed GEX average normalized expression",
                             fontsize_col = 4)
              ggsave("DE_heatmap_gex_075_select_normcounts_rowscale.pdf", phm$gtable,
                     width = 60, height = 20, units = "cm")
...
phm <- pheatmap(t(myexpression_gex), color = hmcol, scale = "none", fontsize = 12,
                             ...
                             main = "Top differentially expressed GEX average raw expression",
                             fontsize_col = 4)
              ggsave("DE_heatmap_gex_075_select_nonescale.pdf", phm$gtable,
                     width = 60, height = 20, units = "cm")  
...
phm <- pheatmap(t(myexpression_gex_n), color = hmcol, scale = "none", fontsize = 12,
                             ...
                             main = "Top differentially expressed GEX average normalized expression",
                             fontsize_col = 4)
              ggsave("DE_heatmap_gex_075_select_normcounts_nonescale.pdf", phm$gtable,
                     width = 60, height = 20, units = "cm")
